...
extension GenerateStrings {
    static let zh = GenerateStrings(
        ...
        localTitle: "本机生成",
        localNote: "用这台 Mac 的 Image Playground 生成：插画 · 动画 · 素描，不耗次数，完成后自动进图库",
        generateAction: "生成",
        generating: "生成中…",
        ...
        monthlyLabel: "本月余额",
        picbiLabel: "pic.bi",
        monthlyValue: { credits, monthly in "\(credits) 次 · 每月配 \(monthly)" },
    ...
    static let en = GenerateStrings(
        ...
        localNote: "Generate with this Mac's Image Playground: illustration · animation · sketch, no credits, lands in your library",
        ...
        picbiLabel: "pic.bi",
        monthlyValue: { credits, monthly in "\(credits) left · \(monthly)/mo" },
